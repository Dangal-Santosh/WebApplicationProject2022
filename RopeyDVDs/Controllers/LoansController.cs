...
namespace RopeyDVDs.Controllers
{
    public class LoansController : Controller
    {
        ...
        public IActionResult Create()
        {
            ...
            ViewData["MemberNumber"] = new SelectList(_context.Member, "MemberNumber", "MemberFirstName");
            return View();
        }
        ...
        /// <summary>
        /// The function is supposed to create a new loan in the database, but it also checks if the
        /// member is underaged for the DVD, if the member has too many DVDs out, and if the DVD is
        /// available
        /// </summary>
        /// <param name="LoanTypeNumber">int</param>
        /// <param name="CopyNumber">int</param>
        /// <param name="MemberNumber">int</param>
        /// <param name="DateTime">DateOut, DateDue, DateReturned</param>
        /// <param name="DateTime">DateOut, DateDue, DateReturned</param>
        /// <param name="DateTime">DateOut, DateDue, DateReturned</param>
        /// <param name="Status">string</param>
        /// <param name="Loan">The loan object that is being created</param>
        /// <returns>
        /// The Create method is returning an IActionResult.
        /// </returns>
